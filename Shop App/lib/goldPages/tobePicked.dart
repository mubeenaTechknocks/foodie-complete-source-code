...
class TobePicked extends StatefulWidget {
  final OrdersModel order;

  const TobePicked({Key key, this.order}) : super(key: key);
  @override
  _TobePickedState createState() => _TobePickedState();
}

class _TobePickedState extends State<TobePicked> {
  @override
            ...
            child: Column(
              ...
              children: [
                ...
                Center(
                  child: ColorButton(
                    buttonAction: () {
                      updateOrderStatus(widget.order.id, "picked")
                          .then((value) {
